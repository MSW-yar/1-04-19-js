...
adding(getdiv, subm);
var getol = creation("ol");
adding(getdiv, getol);

var eventOn = function eventOn() {
  // func made to give an expected change while by enter of click.
  var val = newinpt.value;
  var addli = creation("li");
  var txtval = textIn(addli, val);
  newinpt.value = "";
  buttON = creation("button");
  textIn(buttON, "Delete");
  var inpCheck = creation('input');
  inpCheck.type = 'checkbox';
  adding(addli, inpCheck);

  inpCheck.onchange = function () {
    inpCheck.style.textDecoration = 'lineThrough';
  };
...
//# sourceMappingURL=/type%20script.e31bb0bc.js.map